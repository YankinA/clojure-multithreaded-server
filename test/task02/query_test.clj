...
(deftest make-where-function-test
  (let [students [{:id 10, :surname "Sidorov", :year 1996}
                  {:id 3, :surname "Sidorov", :year 1996}]
        where-function (make-where-function "id" "=" "10")
        result (filterv where-function students)]
    (is (= result [{:id 10, :surname "Sidorov", :year 1996}]))))
